...
cat *_R1.fastq.gz > R1.fq.gz
cat *_R2.fastq.gz > R2.fq.gz


/home/pt40963/scratch/Downloads/trinityrnaseq-Trinity-v2.4.0/Trinity --seqType fq --max_memory 230G --left R1.fq.gz --right R2.fq.gz  --SS_lib_type FR --CPU 8 --output trinity_all_denovo --full_cleanup


transrate --assembly trinity_all_denovo.Trinity.fasta --left R1.fq.gz --right R2.fq.gz --threads 8
wait
cp ./transrate_results/trinity_all_denovo.Trinity/good.trinity_all_denovo.Trinity.fasta ./

transrate --assembly good.trinity_all_denovo.Trinity.fasta --left R1.fq.gz --right R2.fq.gz --threads 8
wait
cp ./transrate_results/good.trinity_all_denovo.Trinity/good.good.trinity_all_denovo.Trinity.fasta ./


transcriptome="good.good.trinity_all_denovo.Trinity.fasta"
...
tax="python $HOME/public_scripts/Diamond_BLAST_add_taxonomic_info/Diamond_blast_to_taxid.py
	...
	-o good.good.trinity_all_denovo.Trinity.fasta.transdecoder.pepsta_vs_nr_tax2.tab"
echo ${tax}
eval ${tax}
wait
...
-i trinity_all_denovo.Trinity.fasta.transdecoder.pepsta_vs_nr_tax2.tab 
--tax_filter_out 6656
-a 30
 --tax_filter_up_to 33208 
