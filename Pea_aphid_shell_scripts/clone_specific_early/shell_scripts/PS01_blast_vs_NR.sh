...
diam_p="/home/pt40963/scratch/Downloads/diamond-master/diamond blastp -p 10 --more-sensitive -e 0.00001 
	   -v -q good.good.trinity_Pea_PS01_denovo.Trinity.fasta.transdecoder.pep
	   -d $HOME/scratch/blast_databases/nr.dmnd 
	   --outfmt 6 
	   --out good.good.trinity_Pea_PS01_denovo.Trinity.fasta.transdecoder.pep_vs_nr.tab"
echo ${diam_p}
eval ${diam_p}
wait
...
tax="python $HOME/public_scripts/Diamond_BLAST_add_taxonomic_info/Diamond_blast_to_taxid.py
	-i good.good.trinity_Pea_PS01_denovo.Trinity.fasta.transdecoder.pep_vs_nr.tab 
	-p $HOME/scratch/blast_databases 
	-o good.good.trinity_Pea_PS01_denovo.Trinity.fasta.transdecoder.pepsta_vs_nr_tax2.tab"
echo ${tax}
eval ${tax}
wait
...
HGT="python $HOME/public_scripts/Lateral_gene_transfer_prediction_tool/Lateral_gene_transfer_predictor.py
 -i good.good.trinity_Pea_PS01_denovo.Trinity.fasta.transdecoder.pepsta_vs_nr_tax.tab 
