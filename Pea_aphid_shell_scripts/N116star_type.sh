...
#$ -cwd
cd  /storage/home/users/pjt6/pea_aphid/clone_sp_genomes/N116_RNAseq_mapping
#rm -rf n116star_indicies
#mkdir n116star_indicies

#/shelf/apps/pjt6/apps/STAR-master/bin/Linux_x86_64_static/STAR  --limitGenomeGenerateRAM 319999281877 --runMode genomeGenerate --runThreadN 24 --genomeDir ./n116star_indicies \
--genomeFastaFiles A.pisum_N116.genome.v1.0.fasta
...
#/shelf/apps/pjt6/apps/STAR-master/bin/Linux_x86_64_static/STAR --genomeDir n116star_indicies/ --limitGenomeGenerateRAM 285554136874 \
