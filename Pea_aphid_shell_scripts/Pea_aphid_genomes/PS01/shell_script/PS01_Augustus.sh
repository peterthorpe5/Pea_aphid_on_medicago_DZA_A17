...
augustus --genemodel=complete --protein=on --start=on --alternatives-from-evidence=true --stop=on --cds=on --introns=on --gff3=on --extrinsicCfgFile=/home/pt40963/Downloads/augustus-3.0.3/config/species/Myzus_cerasi/extrinsic.Myzus_cerasi.cfg --hintsfile=hints.gff --outfile=PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.gff --noInFrameStop=true --strand=both --species=pea_aphid_masked PS01_alt.fasta.1.masked
