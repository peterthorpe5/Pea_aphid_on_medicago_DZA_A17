...
# index the genome
# STAR --runMode genomeGenerate --runThreadN 10 --limitGenomeGenerateRAM  259760745173 --genomeDir /home/pt40963/scratch/pea_aphid_genomes/PS01/star_indicies --genomeFastaFiles /home/pt40963/scratch/pea_aphid_genomes/PS01/PS01_alt.fasta
#wait
#cd /home/pt40963/scratch/pea_aphid_genomes/PS01
#
...
#
#STAR --genomeDir star_indicies/ --limitGenomeGenerateRAM 115554136874 --runThreadN 16 --outSAMtype BAM SortedByCoordinate --outFilterMismatchNmax 7  --outFilterMultimapNmax 5  --readFilesCommand zcat --outFileNamePrefix PS01-rep3 --readFilesIn  /home/pt40963/scratch/pea_aphid_RNAseq_20171104/trimmed_reads/PS01-rep3_R1.fastq.gz  /home/pt40963/scratch/pea_aphid_RNAseq_20171104/trimmed_reads/PS01-rep3_R2.fastq.gz
#wait
...
#
#STAR --genomeDir star_indicies/ --limitGenomeGenerateRAM 115554136874 --runThreadN 16 --outSAMtype BAM SortedByCoordinate --outFilterMismatchNmax 7  --outFilterMultimapNmax 5  --readFilesCommand zcat --outFileNamePrefix PS01-rep4 --readFilesIn  /home/pt40963/scratch/pea_aphid_RNAseq_20171104/trimmed_reads/PS01-rep4_R1.fastq.gz  /home/pt40963/scratch/pea_aphid_RNAseq_20171104/trimmed_reads/PS01-rep4_R2.fastq.gz
#wait
...
samtools sort -@ 4 -o N116-rep1Aligned.sortedByCoord.out.bam_sorted.bam N116-rep1Aligned.sortedByCoord.out.bam
samtools sort -@ 4 -o N116-rep2Aligned.sortedByCoord.out.bam_sorted.bam N116-rep2Aligned.sortedByCoord.out.bam
samtools sort -@ 4 -o N116-rep3Aligned.sortedByCoord.out.bam_sorted.bam N116-rep3Aligned.sortedByCoord.out.bam
samtools sort -@ 4 -o N116-rep4Aligned.sortedByCoord.out.bam_sorted.bam N116-rep4Aligned.sortedByCoord.out.bam
samtools sort -@ 4 -o N116-rep5Aligned.sortedByCoord.out.bam_sorted.bam N116-rep5Aligned.sortedByCoord.out.bam
...
htseq-count --quiet -f bam --type gene --idattr ID avr-rep1Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > avr-rep1Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID N116-rep3Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > N116-rep3Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID PSO1-rep5Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > PSO1-rep5Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID avr-rep2Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > avr-rep2Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID N116-rep4Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > N116-rep4Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID vir-rep1Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > vir-rep1Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID avr-rep3Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > avr-rep3Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID N116-rep5Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > N116-rep5Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID vir-rep2Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > vir-rep2Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID avr-rep4Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > avr-rep4Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID PSO1-rep1Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > PSO1-rep1Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID vir-rep3Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > vir-rep3Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID avr-rep5Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > avr-rep5Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID PSO1-rep2Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > PSO1-rep2Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID vir-rep4Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > vir-rep4Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID N116-rep1Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > N116-rep1Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID PSO1-rep3Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > PSO1-rep3Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID vir-rep5Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > vir-rep5Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID N116-rep2Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > N116-rep2Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID PSO1-rep4Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > PSO1-rep4Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
htseq-count --quiet -f bam --type gene --idattr ID vir-rep4Aligned.sortedByCoord.out.bam_sorted.bam PS01_alt.fasta.1.masked_pea_aphid_masked_modles201801801.renamed.fixed.gff > vir-rep4Aligned.sortedByCoord.out.bam_sorted.bam.htseq.counts
