...
#/home/pt40963/scratch/Downloads/gffread/gffread PHGONA.gff -g ../P.gon.genome.v1.fasta -x Pgona.v1.gene.nt.fasta -y APISUM_PS01.gene.AA.fasta

wait
  
#sed -i -e 's/[.]//g' APISUM_PS01.gene.AA.fasta

wait
 

echo "running diamond-BLAST against NR"
diam_p="/home/pt40963/scratch/Downloads/diamond-master/diamond blastp -p 12 --more-sensitive -e 0.00001 
	   -v -q APISUM_PS01.gene.AA.fasta
	   -d $HOME/scratch/blast_databases/nr.dmnd 
	   --outfmt 6 
	   --out APISUM_PS01.gene.AA.fasta_vs_nr.tab"
echo ${diam_p}
eval ${diam_p}
wait
...
diam_p="/home/pt40963/scratch/Downloads/diamond-master/diamond blastp 
	   ...
	   -q APISUM_PS01.gene.AA.fasta
	   -d $HOME/scratch/blast_databases/nr.dmnd 
	   --outfmt 5 --salltitles
	   --out APISUM_PS01.gene.AA.fasta_vs_nr.xml"
echo ${diam_p}
eval ${diam_p}
wait
...
tax="python $HOME/public_scripts/Diamond_BLAST_add_taxonomic_info/Diamond_blast_to_taxid.py
	-i APISUM_PS01.gene.AA.fasta_vs_nr.tab 
	-p $HOME/scratch/blast_databases 
	-o APISUM_PS01.gene.AA.fasta_vs_nr_tax.tab"
echo ${tax}
eval ${tax}
wait
...
HGT="python $HOME/public_scripts/Lateral_gene_transfer_prediction_tool/Lateral_gene_transfer_predictor.py
 -i APISUM_PS01.gene.AA.fasta_vs_nr_tax.tab 
